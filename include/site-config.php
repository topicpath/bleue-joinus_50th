...
// =============================================================================================================================================================
// 2023-12-31 19:00 アイテム&サービス クローズ
$close_target_date = '2023-12-31 19:00';

$now = date('YmdHi');
$check_date = filter_input(INPUT_GET, 'check_date');
if($check_date) {
	$now = date('YmdHi', strtotime(str_replace('_', '', $check_date)));
}
if($now >= date('YmdHi', strtotime($close_target_date))) {
	$item_service_close_flg = true;
}
