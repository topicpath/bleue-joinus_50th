	...
	<div class="xw">
		...
		<nav>
			<ul class="gnav ff_en">
				...
				<li><a class="coming"<?php if($page_category == 'zoomin') : ?> class="current"<?php endif; ?>>Staff Interview<br> Zoom in!</a></li>
				<li><a class="coming"<?php if($page_category == 'smiles') : ?> class="current"<?php endif; ?>>Let's Celebration<br> SMILES</a></li>
				<li><a class="coming"<?php if($page_category == 'memory') : ?> class="current"<?php endif; ?>>#JOINUS<span>の<br>思い出教えてください</span></a></li>
			</ul><!-- /.gnav -->
		</nav>
	</div><!-- /.mw -->
</header><!-- /#header -->
